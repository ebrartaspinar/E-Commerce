...
This document describes the system design, architecture decisions, and communication patterns of the E-Commerce marketplace platform.
...
E-Commerce is a **marketplace** platform where multiple sellers can list products and buyers can browse, search, add items to a cart, place orders, and receive notifications. The platform is decomposed into six domain-driven microservices, an NGINX API gateway, and a Vue 3 single-page application.
