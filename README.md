...
A full-stack, microservice-based marketplace e-commerce platform. Built with Java 17/Spring Boot on the backend, Vue 3/TypeScript on the frontend, and featuring a unique **"Cozy Pixel"** RPG-inspired visual theme with the Press Start 2P font.
